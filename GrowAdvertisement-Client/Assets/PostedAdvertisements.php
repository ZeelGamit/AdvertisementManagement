...
$qry =
    "select AdID,CEmail,ImgURL,CompanyName,PublisherName,AdDays,CurrDate from PostAdTB a,PublisherTB p where a.PublisherID = p.PublisherID and CEmail='" .
    $_SESSION['uEmail'] .
    "'";
                                    ...
                                    <table class="table table-hover  zero-configuration">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="Images/avatar/1.jpg" alt="Advertisement">
                                                </td>
