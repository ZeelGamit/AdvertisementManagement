        ...
        <div class="nav-header">
            <div class="brand-logo">
                <a href="Home.php">
                    ...
                    <!-- <span class="logo-compact"><img src="./images/G-Logo.png" alt=""></span> -->
                            ...
                            <div class="drop-down dropdown-profile animated fadeIn dropdown-menu">
                                <div class="dropdown-content-body">
                                    <ul>
                                        ...
                                        <li><a href="././PageLogout.php"><i class="icon-key"></i>
                                                <span>Logout</span></a>
                                        </li>
                                    </ul>
                                </div>
                ...
                <ul class="metismenu" id="menu">
                    <li>
                        <a href="Home.php" aria-expanded="false">
                            <i class="bi bi-house-door text-white"></i><span class="nav-text">Home</span>
                        </a>
                    </li>
