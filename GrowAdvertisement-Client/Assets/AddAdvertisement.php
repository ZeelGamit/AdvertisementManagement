...
<head>
    ...
    <!-- <link href="Groovin/GrowAdvertisement-Client/Assets/css/style.css" rel="stylesheet"> -->
                ...
                <div class="row justify-content-center" style="margin: 0rem">
                    <div class="col-lg-12" style="padding: 0rem">
                        <div class="card" style="margin-bottom: 0rem;">
                            <div class="card-body">
                                <div style="margin-bottom: 25px;" class=" d-flex justify-content-center">
                                ...
                                <div class="form-validation">
                                    <form class="form-valide" method="post">
                                        <div class="form-group row">
                                            <label class="col-lg-3 col-form-label" for="val-companyname">Company
                                                Name
                                                <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-9">
                                                <input type="text" class="form-control" id="val-companyname"
                                                    name="val-companyname" placeholder="Enter a companyname.." required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-3 col-form-label" for="val-publisher">Select
                                                Publisher
                                                <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-9">
                                                <select class="form-control" id="val-publisher" name="val-publisher"
                                                    required>
                                                    <?php while (
                                                    ...
                                                    <option value="<?php echo $publisher[
                                                            'PublisherID'
                                                        ]; ?>">
                                                        <?php echo $publisher[
                                                                'PublisherName'
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-3 col-form-label" for="val-imgurl">Select File<span
                                                    class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-9">
                                                <input type="File" class="form-control" id="val-imgurl"
                                                    name="val-imgurl" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-3 col-form-label" for="val-addays">Number of days
                                                <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-9">
                                                <input type="number" class="form-control" id="val-addays"
                                                    name="val-addays" required>
                                            </div>
                                        </div>
                                        <div class="form-group row d-flex justify-content-center">
                                            <div class="">
                                                <button type="submit" class="btn submit-for-feedback" name="btnSubmit"
