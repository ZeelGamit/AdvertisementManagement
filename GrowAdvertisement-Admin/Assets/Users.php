...
$qry =
    'select Email,CFname,CLname,CSurename,ContactNo,Address,CName,StateName,CityName,Gender,CurrentDate from clienttb u, CountryTB c , StateTB s , CityTB ct where u.CountryID = c.CountryID and u.StateID = s.StateID and u.CityID = ct.CityID';
